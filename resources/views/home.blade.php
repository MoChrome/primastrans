...
@section('container')
    <section id="hero" class="hero">
        ...
        <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
            ...
            <div class="carousel-item" style="background-image: url({{ asset('img/hero-carousel/hero-carousel-2.jpg') }})">
            </div>
            <div class="carousel-item" style="background-image: url({{ asset('img/hero-carousel/hero-carousel-3.jpg') }})">
            </div>
    ...
    <main id="main">
        ...
        <section id="profile" class="alt-services">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row justify-content-around gy-4">
                    <div class="col-lg-5 img-bg" style="background-image: url({{ asset('img/daily-inspection.jpg') }});"
                    ...
                    <div class="col-lg-6 d-flex flex-column justify-content-center">
                        ...
                        <p>PT Primastrans Tri Mandiri merupakan perusahaan yang bergerak dibidang angkutan darat yang
                            berbasis di Kota Tasikmalaya dan beroperasi di wilayah Jawa Barat. Kami menyediakan layanan
                            angkutan darat.</p>
                        <p>Kami melayani berbagai macam angkutan jalur darat mulai dari pengiriman produk, batubara dan
                            lainnya menggunakan truk box/wingbox dan truk dump.</p>
        ...
        <section id="services" class="services section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    <h2>Layanan</h2>
                    <p>PT Primastrans Tri Mandiri berbasis di Kota Tasikmalaya dan beroperasi di wilayah Jawa Barat. Kami
                        menyediakan layanan pengiriman berdasarkan barang yang akan diangkut.</p>
                </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row justify-content-around gy-4">
                    ...
                    <div class="col-lg-5 d-flex flex-column justify-content-center">
                        <h3>Kenapa Kami?</h3>
                        <p>Kami PT Primastrans Tri Mandiri menawarkan layanan angkutan darat yang memiliki keunggulan dalam
                            banyak hal</p>

                        <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="100">
                            <i class="bi bi-person-circle flex-shrink-0"></i>
                            <div>
                                <h4><a href="#" class="stretched-link" onClick="return false;">Tenaga Profesional</a>
                                </h4>
                        ...
                        <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div>
                                <h4><a href="#" class="stretched-link" onClick="return false;">Pengiriman Tepat
                                        Waktu</a></h4>
                        ...
                        <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div>
                                <h4><a href="#" class="stretched-link" onClick="return false;">Pelayanan Memuaskan</a>
                                </h4>
                        ...
                        <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div>
                                <h4><a href="#" class="stretched-link" onClick="return false;">Harga Ekonomis</a>
                                </h4>
                    ...
                    <div class="container">
                        ...
                        <div class="row" data-aos="zoom-in">
                            ...
                            <div class="col-lg-12 col-md-12 col-12 d-flex align-items-center justify-content-center">
                                <a href="https://www.ibaralioho.co.id/" target="_blank"><img
                                        src="{{ asset('img/clients/client-1.png') }}" class="img-fluid"
                                        alt=""></a>
                            </div>
